...
//        }
    ...
    isPercentInvalid: function (percent) {
        return (app.validator.isEmpty(percent) || !app.validator.isNumber(percent) || parseFloat(percent) < 0.01 || parseFloat(percent) > 100);
    }
}
...
app.uploadHelper = {
    ...
    pluploader: function (options) {
        ...
        if ("image" == fileType) {
            ...
            filterRule = {
                title: 'file',
                extensions: 'rar,doc,docx,ppt,pptx,xls,xlsx',
                mimeTypes: 'application/octet-stream'
            }
