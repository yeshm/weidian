...
public class SecurityUtil {
    ...
    public static GenericValue getUserLogin(Delegator delegator, String partyId) throws GenericEntityException {
        GenericValue userLogin = ExtEntityUtil.getOnlyCache(delegator, "UserLogin", UtilMisc.toMap("partyId", partyId));
