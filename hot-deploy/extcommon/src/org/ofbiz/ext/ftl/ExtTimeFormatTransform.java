 ...
 * <@extDateTimeFormat date=date format="HH:mm:ss"/>
 */
public class ExtTimeFormatTransform implements TemplateTransformModel {

    public final static String module = ExtTimeFormatTransform.class.getName();
    ...
    public Writer getWriter(final Writer out, final Map args) {
        ...
        final Timestamp date = ExtTimeFormatTransform.getTimestamp(args, "date");

        String formatTemp = ExtTimeFormatTransform.getArg(args, "format");
        if (UtilValidate.isWhitespace(formatTemp)) formatTemp = "HH:mm:ss";
