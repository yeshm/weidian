...
/**
 * UEditor 1.3.6版文件上传辅助类
 *
 */
public class Uploader136 {
    ...
    public Uploader136(HttpServletRequest request) {
        this.request = request;
        this.params = new HashMap<String, String>();

        this.setMaxSize(Uploader136.MAX_SIZE);
    ...
    private void parseParams() {
        ...
        try {
            ...
            sfu.setHeaderEncoding(Uploader136.ENCODEING);
    ...
    private String getPhysicalPath(String path) {
        ...
        String realPath = FlexibleStringExpander.expandString(UtilProperties.getPropertyValue("extcommon", "upload.server.path"), context);
